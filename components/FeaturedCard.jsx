...
export default function FeaturedPropertiesCard({ property }) {
  const getRatesDisplay = () => {
    if (property.rates.monthly !== undefined) {
      return `$${property.rates.monthly}/mo`;
    } else if (property.rates.weekly !== undefined) {
      return `$${property.rates.weekly}/we`;
    } else if (property.rates.nightly !== undefined) {
      return `$${property.rates.nightly}/ni`;
    } else {
      ...
      <div className="p-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between">
          <div className="flex align-middle gap-2 mb-4 lg:mb-0">
            <FaLocationDot className="text-lg text-orange-700"></FaLocationDot>
